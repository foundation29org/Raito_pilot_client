...
export const HROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { path: '/inmunodeficiencies', title: 'menu.Clinical data of inmunodeficiencies', icon: 'ft-arrow-right submenu-icon', class: '', isExternalLink: false, submenu: [] },
  ...
  },
  {
    ...
    submenu:  [
      { path: '/pages/profile', title: 'navbar.My Profile', icon: 'ft-edit', class: '', isExternalLink: false, submenu: [] },
